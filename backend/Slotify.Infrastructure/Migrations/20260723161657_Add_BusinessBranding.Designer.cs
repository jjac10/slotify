...
namespace Slotify.Infrastructure.Migrations
{
    ...
    [Migration("20260723161657_Add_BusinessBranding")]
    partial class Add_BusinessBranding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.BusinessHour", b =>
                {
                    ...
                    b.ToTable("business_hours", null, t =>
                        {
                            t.HasCheckConstraint("ck_business_hours_times", "opening_time < closing_time OR is_closed = true");
                        });
                });

            modelBuilder.Entity("Slotify.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.GuestOtpCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ContactHash", "CreatedAt");

                    b.ToTable("guest_otp_codes", (string)null);
                });

            modelBuilder.Entity("Slotify.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.StaffServiceAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.WaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ServiceId", "Date", "UserId")
                        .IsUnique();
                    ...
                    b.ToTable("waitlists", null, t =>
                        {
                            t.HasCheckConstraint("waitlist_user_or_guest", "(user_id IS NOT NULL AND guest_id IS NULL) OR (user_id IS NULL AND guest_id IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.HasOne("Slotify.Domain.Entities.Reservation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Slotify.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("Slotify.Domain.Entities.Guest", "Guest")
                        .WithMany()
                        .HasForeignKey("GuestId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Slotify.Domain.Entities.Service", "Service")
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Slotify.Domain.Entities.Staff", "Staff")
                        .WithMany()
